...
本次项目，其理论虽然不难，但是从开始的数据处理问题百花齐放，到模型微调时的格式问题、资源问题，稳定性问题，到设计服务器时的资源使用管理，以及到最后的设计前端优化体验，均属于工程实践问题，处理起来需要丰富的经验以及百折不挠的心态。而均衡合理的分工协作，则是将一个复杂系统进行拆解，逐个击破的不二法门。我们从本次项目经历中收获颇丰，也希望将来能够继续努力，再接再厉。
